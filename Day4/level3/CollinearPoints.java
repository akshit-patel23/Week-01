...
public class CollinearPoints {
    ...
    public static double calculateSlope(double x1, double y1, double x2, double y2) {
        return (y2 - y1) / (x2 - x1); // Slope formula: (y2 - y1) / (x2 - x1)
    }
    ...
    public static boolean arePointsCollinearUsingSlope(double x1, double y1, double x2, double y2, double x3, double y3) {
        double slopeAB = calculateSlope(x1, y1, x2, y2); // Slope between points A and B
        double slopeBC = calculateSlope(x2, y2, x3, y3); // Slope between points B and C
        double slopeAC = calculateSlope(x1, y1, x3, y3); // Slope between points A and C
    ...
    public static boolean arePointsCollinearUsingArea(double x1, double y1, double x2, double y2, double x3, double y3) {
        // Calculate the area of the triangle formed by the points using the determinant method
    ...
    public static void main(String[] args) {
        ...
        // Prompt the user to input coordinates for the three points
